...
populationSize = 100;
numberOfVariables = 2;
numberOfGenesPerVariable = 30;
crossoverProbability = 0.8;
numberOfGenes = numberOfGenesPerVariable*numberOfVariables;
...
for iGeneration = 1:numberOfGenerations
  ...
  elitePopulation = InsertBestIndividual(tempPopulation,bestIndividual,numberOfElitismCopies);
...
globalMinimumValue = 1/ maximumFitness;

resultPrintParametes=fprintf('Parameters: Population size = %d, Pcross = %.2f, Pmut = %.3f, Ptour = %.2f, Tournament size = %d \n',...
  populationSize,crossoverProbability, mutationProbability,...
  tournamentSelectionParameter,tournamentSize);
resultPrint=fprintf('Minimum value of %.3f found at x1 = %.3f, x2 = %.3f \n ',globalMinimumValue,xBest(1),xBest(2));
